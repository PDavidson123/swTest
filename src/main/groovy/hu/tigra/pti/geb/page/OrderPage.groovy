...
class OrderPage extends Page {
    ...
    static content = {
        ...
        summaryFirstRow(required: false) { $('#cart_summary>tbody>tr:first-of-type').module(ProductRow) }
        shippingAgreeTerms(required: false) {}
        paymentCheckButton(required: false) { $('a.button.btn.btn-default.standard-checkout.button-medium') }
